...
#=
Ω = -20:0.01:20
Ω_nyquist = π / (tgate / nsegments)
Ω = -Ω_nyquist:0.01:Ω_nyquist
...
plot!(Ω[Ω .> 0]/2π, abs.(U[Ω .> 0]), yscale=:log, label="ω > 0");
plot!(-Ω[Ω .< 0]/2π, abs.(U[Ω .< 0]), yscale=:log, c=:red, label="ω < 0")
